...
public class DrawerFactory {
    ...
    public Object3D getPointDrawer(ModelSurfaceView modelSurfaceView) {
        if (object3dv1 == null) {
            object3dv1 = new Object3DV1(modelSurfaceView);
        }
        return object3dv1;
    }
    ...
    public Object3D getDrawer(Object3DData obj, boolean usingTextures, boolean usingLights, boolean usingAnimation, ModelSurfaceView modelSurfaceView) throws IOException {

        if (object3dv2 == null) {
            try {
                getPointDrawer(modelSurfaceView);
                ...
                Log.e(TAG, "Error creating drawer: " + e.getMessage(), e);
            }
        }
        ...
        if (isAnimated) {
            if (isUsingLights) {
                if (isTextured) {
                    if (!isColoured) {
                        Log.e(TAG, "return object3dv9");
                        return object3dv9;
                    } else {
                        Log.e(TAG, "No drawer for this object");
                        return null;
                    }
                } else {
                    if (isColoured) {
                        Log.e(TAG, "return object3dv11");
                        return object3dv11;
                    } else {
                        Log.e(TAG, "return object3dv10");
                        return object3dv10;
                    }
                }
            } else {
                if (isTextured) {
                    if (!isColoured) {
                        Log.e(TAG, "return object3dv91");
                        return object3dv91;
                    } else {
                        Log.w(TAG, "No drawer for this object");
                        return null;
                    }
                } else {
                    if (!isColoured) {
                        Log.e(TAG, "return object3dv12");
                        return object3dv12;
                    } else {
                        Log.e(TAG, "No drawer for this object");
                        return null;
            ...
            if (isUsingLights) {
                if (isTextured) {
                    if (isColoured) {
                        Log.e(TAG, "return object3dv6");
                        return object3dv6;
                    } else {
                        Log.e(TAG, "return object3dv8");
                        return object3dv8;
                    }
                } else {
                    if (isColoured) {
                        Log.e(TAG, "return object3dv5");
                        return object3dv5;
                    } else {
                        Log.e(TAG, "return object3dv7");
                        return object3dv7;
                    }
                }
            } else {
                if (isTextured) {
                    if (isColoured) {
                        Log.e(TAG, "return object3dv4");
                        return object3dv4;
                    } else {
                        Log.e(TAG, "return object3dv3");
                        return object3dv3;
                    }
                } else {
                    if (isColoured) {
                        Log.e(TAG, "return object3dv2");
                        return object3dv2;
                    } else {
                        Log.e(TAG, "return object3dv1");
                        return object3dv1;
                    }
                }
            }
