...
public class WavefrontLoader {
    ...
    public WavefrontLoader(String nm, ModelSurfaceView modelSurfaceView) {
    ...
    public WavefrontLoader(String nm, String path) {
            ...
            while ((line = br.readLine()) != null) {
                ...
                if (line.length() > 0) {
                    if (line.startsWith("v ")) {
                        ...
                        Log.e(TAG, "materialLibPath: " + line.substring(7));
//                        String materialLibPath = path.subSequence(0, path.length() - 3) + "mtl";
//                        Log.e(TAG, "materialLibPath: " + materialLibPath);
//                        materials = new Materials(materialLibPath);
    ...
    public void allocateBuffers() {
        ...
        Log.e(TAG, "numVerts: " + numVerts);
        Log.e(TAG, "numNormals: " + numNormals);
        if (numNormals > 0) {
