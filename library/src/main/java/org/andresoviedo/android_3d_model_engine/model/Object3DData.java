...
public class Object3DData {
    ...
    /**
     * in case system doesn't support ints
     */
    private ShortBuffer shortDrawOrderBuffer = null;
    ...
    public Object3DData(FloatBuffer verts, FloatBuffer normals, ArrayList<Tuple3> texCoords, Faces faces,
        ...
        // parameter "faces" could be null in case of async loading
        this.faces = faces;
    ...
    public List<ObjData> getObjData() {
        return objData;
    }

    public void setObjData(List<ObjData> objData) {
